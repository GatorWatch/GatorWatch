            ...
            try:
                ...
                # Display list of popular movies
                    ...
                    try:
                        ...
                        Logging.write("System", "I'm sorry, I couldn't request data for movies.")
                        self.msgLayout.addWidget(MyWidget("I'm sorry, I couldn't request data for movies."))
                    ...
                    if movieToLookup is None or movieToLookup == "":
                        ...
                        if "cancel" in movieToLookup.lower() or "stop" in movieToLookup.lower():
